  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        ...
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">Order Id : #234234</h1>
        <p className="leading-relaxed mb-4">Your Order has been succefully placed</p>
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">SubTotal: ₹5889.00</span>
        </div>
          <div className='my-6'>
