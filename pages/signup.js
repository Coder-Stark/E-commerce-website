...
const Signup = () => {
  ...
  return (
    ...
    <div>
      <img className="mx-auto h-40 w-auto" src="/logo.png" alt="Your Company"/>
    ...
    <form onSubmit = {handleSubmit} className="mt-8 space-y-6"  method="POST">
      ...
      <div className="-space-y-px rounded-md shadow-sm">
        <div>
          ...
          <input value={name} onChange={handleChange} id="name" name="name" type="text" required className="relative block w-full rounded-t-md border-0 px-1.5 py-1,5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-gray-600 sm:text-sm sm:leading-6" placeholder="Your Name"/>
        </div>
        <div>
