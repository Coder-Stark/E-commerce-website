...
const Post = ({addToCart}) => {
  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-center rounded" src="https://m.media-amazon.com/images/I/61wy1MD4KKL._AC_UL320_.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">COZYCLOTH</h2>
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">WRAP IN COMFORT(XL/Blue)</h1>
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">₹599.00</span>
          <button className="flex ml-4 text-white bg-gray-500 border-0 px-1 items-center focus:outline-none hover:bg-gray-600 rounded">Buy Now</button>
          <button onClick={()=>{addToCart(slug, 1,499, 'wrap in cozy(XL, Black)','XL','Black') } } className="flex ml-4 text-white bg-gray-500 border-0 px-1 items-center focus:outline-none hover:bg-gray-600 rounded">Add to Cart</button>
